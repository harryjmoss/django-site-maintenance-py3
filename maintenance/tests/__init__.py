...
from maintenance.api import ERROR_TIMEOUT, SUCCESS, MaintenanceModeError
from maintenance.tests.future import SimpleTestCase
from maintenance.utils import CommandTask, register_session
...
class TestCommand(TestCase, MaintenanceTestCaseMixIn):
    ...
    def test_timeout(self):
        ...
        self.assertRaises(
            SystemExit, call_command, "offline", "activate", verbosity=0, timeout=3
        )
